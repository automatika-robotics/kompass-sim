...
"""Launch Webots TurtleBot3 Burger driver. + Map Server + Robot Localization"""
...
def generate_launch_description():
    webots_package_dir = get_package_share_directory("webots_ros2_turtlebot")
    ...
    ros2_control_params = os.path.join(
        webots_package_dir, "resource", "ros2control.yml"
    )
    ...
    robot_description_path = os.path.join(
        webots_package_dir, "resource", "turtlebot_webots.urdf"
    )
    ros2_control_params = os.path.join(
        webots_package_dir, "resource", "ros2control.yml"
    )
    ...
    map_server_config_path = os.path.join(
        this_package_dir, "maps", "turtlebot3_webots.yaml"
    )
